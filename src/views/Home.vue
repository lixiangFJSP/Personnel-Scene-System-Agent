<template>
  <div class="home">
    <div class="hero">
      ...
      <span class="hero-badge">共 {{ modules.length }} 个分析模块 · 选择模块进入查看详情</span>
    </div>

    <div class="toolbar">
      <router-link to="/import" class="import-btn">
...
const modules = [
  {
    title: '无感考勤',
    desc: '全厂考勤数据汇总、趋势分析、异常诊断与改善建议。覆盖考勤趋势、出勤规模及异常率分析。',
...
.hero{
  ...
  color:#fff;border-radius:12px;padding:32px 28px 28px;
...
.hero h1{font-size:26px;font-weight:700;letter-spacing:1px;position:relative;z-index:1}
.hero p{margin-top:8px;font-size:14px;opacity:.88;position:relative;z-index:1}
.hero-badge{
